...
func NewUserServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) UserServiceClient {
	...
	return &userServiceClient{
		...
		updatePasswordUser: connect_go.NewClient[v1.UpdatePasswordUserRequest, v1.UpdatePasswordUserResponse](
			httpClient,
			baseURL+UserServiceUpdatePasswordUserProcedure,
			opts...,
		),
	}
}
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle(UserServiceUpdatePasswordUserProcedure, connect_go.NewUnaryHandler(
		UserServiceUpdatePasswordUserProcedure,
