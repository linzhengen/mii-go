...
const (
	...
	UserService_UpdatePasswordUser_FullMethodName = "/user.v1.UserService/UpdatePasswordUser"
)
...
func (c *userServiceClient) UpdatePasswordUser(ctx context.Context, in *UpdatePasswordUserRequest, opts ...grpc.CallOption) (*UpdatePasswordUserResponse, error) {
	out := new(UpdatePasswordUserResponse)
	err := c.cc.Invoke(ctx, UserService_UpdatePasswordUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) UpdatePasswordUser(context.Context, *UpdatePasswordUserRequest) (*UpdatePasswordUserResponse, error) {
