...
func (x *UpdatePasswordUserRequest) GetEmail() string {
	if x != nil {
		return x.Email
	}
	return ""
...
type User struct {
	...
	Email   string                 `protobuf:"bytes,3,opt,name=email,proto3" json:"email,omitempty"`
	Status  User_Status            `protobuf:"varint,5,opt,name=status,proto3,enum=user.v1.User_Status" json:"status,omitempty"`
...
var file_user_v1_user_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x22, 0x3d, 0x0a, 0x11, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65,
	...
	0x69, 0x6c, 0x22, 0x37, 0x0a, 0x12, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72,
	...
	0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0x4d, 0x0a, 0x19, 0x55,
	...
	0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x3f, 0x0a, 0x1a, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x55, 0x73, 0x65, 0x72,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x21, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31,
	0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0xa4, 0x02, 0x0a, 0x04,
	...
	0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x2e, 0x53, 0x74,
	...
	0x07, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x22, 0x48, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74,
	...
	0x10, 0x02, 0x32, 0xb8, 0x02, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x55, 0x73, 0x65, 0x72, 0x12, 0x22, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x55,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x55, 0x73, 0x65,
	...
	0x64, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x8f, 0x01,
	...
	0x6e, 0x2f, 0x6d, 0x69, 0x69, 0x2d, 0x67, 0x6f, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75,
	0x66, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x76, 0x31, 0x3b, 0x75, 0x73,
...
var file_user_v1_user_proto_goTypes = []interface{}{
	...
	(*UpdatePasswordUserRequest)(nil),  // 7: user.v1.UpdatePasswordUserRequest
	(*UpdatePasswordUserResponse)(nil), // 8: user.v1.UpdatePasswordUserResponse
	(*User)(nil),                       // 9: user.v1.User
	(*timestamppb.Timestamp)(nil),      // 10: google.protobuf.Timestamp
}
var file_user_v1_user_proto_depIdxs = []int32{
	9,  // 0: user.v1.GetUserResponse.user:type_name -> user.v1.User
	9,  // 1: user.v1.CreateUserResponse.user:type_name -> user.v1.User
	9,  // 2: user.v1.UpdateUserResponse.user:type_name -> user.v1.User
	9,  // 3: user.v1.UpdatePasswordUserResponse.user:type_name -> user.v1.User
	0,  // 4: user.v1.User.status:type_name -> user.v1.User.Status
	10, // 5: user.v1.User.created:type_name -> google.protobuf.Timestamp
	10, // 6: user.v1.User.updated:type_name -> google.protobuf.Timestamp
	1,  // 7: user.v1.UserService.GetUser:input_type -> user.v1.GetUserRequest
	3,  // 8: user.v1.UserService.CreateUser:input_type -> user.v1.CreateUserRequest
	5,  // 9: user.v1.UserService.UpdateUser:input_type -> user.v1.UpdateUserRequest
	7,  // 10: user.v1.UserService.UpdatePasswordUser:input_type -> user.v1.UpdatePasswordUserRequest
	...
	8,  // 14: user.v1.UserService.UpdatePasswordUser:output_type -> user.v1.UpdatePasswordUserResponse
